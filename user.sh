...
cp /home/centos/shellscript-roboshop/user.service /etc/systemd/system/user.service &>>$LOGFILE
...
mongo --host mongodb.vishwadomain.online </app/schema/user.js &>>$LOGFILE
